...
SECRET_KEY = 'django-insecure-tue@!wnf!zhe=sl#t8#hj@y$*ek!4xgiifr##tib#-n+1^a=gh'
...
LOGIN_REDIRECT_URL = 'home' #page diplayed after login
...
SECURE_CONTENT_TYPE_NOSNIFF = True #client cannot guess content
